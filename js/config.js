...
const METRIC_TIPS = {
  ...
  // ── 投放面板 ──
  spend:        { label: '投放花费',         tip: '万象台商品报表「花费」累计值，含人群+关键词渠道。按商品报表口径统计，短视频另计。' },
  ad_roi:       { label: '投放 ROI',         tip: '成交金额 ÷ 投放花费。注意：成交金额含间接成交，口径与淘宝后台可能略有差异。' },
  ad_ctr:       { label: '推广 CTR',         tip: '万象台商品报表 CTR 字段均值（点击量 ÷ 展现量）。仅含有效曝光商品。' },
  audience_pct: { label: '人群渠道占比',     tip: '人群推广花费 ÷ 总推广花费（人群+关键词）× 100%。计划目标73.1%。' },
  keyword_pct:  { label: '关键词渠道占比',   tip: '关键词推广花费 ÷ 总推广花费 × 100%。计划目标26.9%。' },
  video_spend:  { label: '短视频推广花费',   tip: '内容报表「短视频」类型花费累计，与搜推报表花费分开统计，不含在总推广花费中。' },
